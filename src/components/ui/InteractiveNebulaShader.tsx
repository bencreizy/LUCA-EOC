...
export function InteractiveNebulaShader({
  ...
  useEffect(() => {
    ...
    const fragmentShader = `
      ...
      void main() {
        ...
        // Add 70% opacity (increased by 20%)
        gl_FragColor.a *= 0.7;
      }
    `;
    ...
    renderer.setAnimationLoop(() => {
      // Slowed down nebula speed significantly
  ...
  // Removed scaling and adjusting for standard behavior with sizing provided by standard canvas.
  return (
    <div
      ref={containerRef}
      className={`fixed inset-0 pointer-events-none z-10 w-full h-full scale-150 transform ${className}`}
